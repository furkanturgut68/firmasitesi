...
<!-- Slider Start -->
<section class="banner" style="background-image:url(resimler/<?php echo $sliderler['resim'] ?>)">
	<div class="container">
		<div class="row">
			<div class="col-lg-6 col-md-12 col-xl-7">
				<div class="block">
					<div class="divider mb-3"></div>
					<h1 class="mb-3 mt-3"><?php echo $sliderler['baslik'] ?></h1>
					
					<p class="mb-4 pr-5"><?php echo $sliderler['aciklama'] ?></p>
					<div class="btn-container ">
						<a href="iletisim.php" target="_blank" class="btn btn-main-2 btn-icon btn-round-full">İletişim<i class="icofont-simple-right ml-2  "></i></a>
					</div>
				</div>
			</div>
		</div>
